...
public class WeChatServiceImpl implements WeChatService {
    ...
    @Override
    public Map<String, Object> processRequest(Map requestMap) {
            ...
            if (eventType.equals(WeChatMesUtil.EVENT_TYPE_SUBSCRIBE)) {
                ...
                try {
                    ...
                    if (null != responseBody.get("subscribe")) {
                        ...
                        map.put("resultMes", "first");
                        map.put("resultMsg", "mo-爱心 盼星星，盼月亮，你终于来鸟~\n欢迎访问大花博客公众号\n网页版请访问" + StaticAddressUtil.yuming + "\n" + resultMsg);
    ...
    public String CreateMenu() {
        ...
        if (!"none".equals(accessToken)) {
            ...
            String data = "{" +
                    ...
                    "			\"type\": \"view\"," +
                    "			\"name\": \"主页\"," +
                    "			\"url\": \"" + WeChatMesUtil.WeChat_Index_URL + "\"" +
                    "		}," +
                    "		{" +
                    "			\"type\": \"view\"," +
                    "			\"name\": \"图片\"," +
                    "			\"url\": \"" + WeChatMesUtil.WeChat_MyWorld_URL + "\"" +
                    "		}," +
                    "		{" +
                    "			\"type\": \"scancode_push\"," +
                    "			\"name\": \"扫一扫\"," +
             ...
             *             "type": "view",
             *             "name": "主页",
             *             "url": "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxec7c849d109a54f3&redirect_uri=http://www.dahuaboke.com/login&response_type=code&scope=snsapi_base&state=index#wechat_redirect"
             *         },
             *         {
             *             "type": "view",
             *             "name": "图片",
             *             "url": "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxec7c849d109a54f3&redirect_uri=http://www.dahuaboke.com/login&response_type=code&scope=snsapi_base&state=myworld#wechat_redirect"
             *         },
             *         {
             *             "type": "scancode_push",
             *             "name": "扫一扫",
