...
public class RocketMQUtil implements ApplicationContextAware {
	...
	public static void main(String[] args) {
		producer("182.61.133.77:9876","dwq","dahuaboke","tagSave","123");
		//customer("182.61.133.77:9876","dwq","boke");
	}
	 ...
	 * @param topicName     topic名称
	 * @param       调用的dao层bean的名字
	 */
	public static void customer(String ip, String customerName, String topicName){
		
		final UserService userServiceImpl = (UserService) getApplicationContext().getBean("userServiceImpl");
